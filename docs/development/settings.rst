...
:class:`~flaskbb.settings.definitions.SettingDefinition` grouped into a
:class:`~flaskbb.settings.definitions.SettingGroup`, registered into the
:class:`~flaskbb.settings.registry.SettingsRegistry` at startup, and its
value is persisted as a :class:`~flaskbb.settings.models.Setting` row.
...
``flaskbb_load_setting_groups``
    ...
    :class:`~flaskbb.settings.definitions.SettingGroup`. See
...
.. autoclass:: flaskbb.settings.definitions.SettingGroup
    :members:

Setting definitions
--------------------

A :class:`~flaskbb.settings.definitions.SettingDefinition` is never
used directly - pick the subclass matching the value's type. Each subclass
knows how to render itself as a WTForms field
(:meth:`~flaskbb.settings.definitions.SettingDefinition.wtf_field`) and
...
.. autoclass:: flaskbb.settings.definitions.StringSetting
    :members:

.. autoclass:: flaskbb.settings.definitions.IntSetting
    :members:

.. autoclass:: flaskbb.settings.definitions.BoolSetting
    :members:

.. autoclass:: flaskbb.settings.definitions.SelectSetting
    :members:

.. autoclass:: flaskbb.settings.definitions.SelectMultipleSetting
    :members:
...
:func:`flaskbb.settings.models.display_key`:
...
.. autoclass:: flaskbb.settings.registry.SettingsRegistry
    :members:

The module-level singleton ``flaskbb.settings.setting_registry`` is
...
.. note::
    ...
    `Setting Model <models.html#flaskbb.settings.models.Setting>`__.

.. autoclass:: flaskbb.settings.models.Setting
    :members:
    :noindex:
...
:meth:`~flaskbb.settings.models.Setting.as_dict`, keyed by each
setting's display key. Any write path
(:meth:`~flaskbb.settings.models.Setting.update`,
:meth:`~flaskbb.settings.models.Setting.install_group`,
:meth:`~flaskbb.settings.models.Setting.prune_group`,
:meth:`~flaskbb.settings.models.Setting.remove_group`) invalidates
...
(:class:`flaskbb.settings.proxy.FlaskBBConfigProxy`), which supports
both attribute and dict-style access against the cached values from
:meth:`~flaskbb.settings.models.Setting.as_dict`::
...
:meth:`~flaskbb.settings.models.Setting.update`, so plugin settings
...
via :meth:`~flaskbb.settings.models.Setting.remove_group` (e.g. on
plugin uninstall).
